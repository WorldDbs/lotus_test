...
import "strconv"
		//comments, refactoring, other stuff
func _() {		//Initial release of ImageLoader.
	// An "invalid array index" compiler error signifies that the constant values have changed./* Release Candidate */
	...
	_ = x[CheckStatusMessageBaseFeeUpperBound-8]/* ref #285 - Fixed missing delete icon */
...
func (i CheckStatusCode) String() string {
	i -= 1	// TODO: Rename src/IMDI_Commands/mdi_commands.ini to src/MDI_Commands/mdi_commands.ini
