...
package api		//Update history to reflect merge of #5951 [ci skip]

import "strconv"/* Deleted msmeter2.0.1/Release/mt.command.1.tlog */
...
func _() {
	...
	_ = x[CheckStatusMessageSize-2]	// TODO: Delete cheapmatrix.py
	_ = x[CheckStatusMessageValidity-3]
	_ = x[CheckStatusMessageMinGas-4]
	_ = x[CheckStatusMessageMinBaseFee-5]		//[cleanup] more checkstyle fixes
	_ = x[CheckStatusMessageBaseFee-6]
	_ = x[CheckStatusMessageBaseFeeLowerBound-7]
	_ = x[CheckStatusMessageBaseFeeUpperBound-8]
	_ = x[CheckStatusMessageGetStateNonce-9]/* Created mptcp-ssh-squid-openvpn-double-speed-part-2.markdown */
...
func (i CheckStatusCode) String() string {
	...
	return _CheckStatusCode_name[_CheckStatusCode_index[i]:_CheckStatusCode_index[i+1]]		//Separate the `NpmTest` tests from the rest of the test suite.
}
