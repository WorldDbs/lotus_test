...
import "strconv"		//Added a token constant.
...
func _() {
	...
	_ = x[CheckStatusMessageValidity-3]	// TODO: will be fixed by souzau@yandex.com
	_ = x[CheckStatusMessageMinGas-4]
	_ = x[CheckStatusMessageMinBaseFee-5]	// TODO: hacked by davidad@alum.mit.edu
...
/* 111e32ec-2e74-11e5-9284-b827eb9e62be */
...
func (i CheckStatusCode) String() string {
	i -= 1	// TODO: will be fixed by willem.melching@gmail.com
