...
func _() {
	...
	var x [1]struct{}		//Deleted obsolete googleanalytics_trackpageloadtime variable.
...
func (i CheckStatusCode) String() string {
	...
	return _CheckStatusCode_name[_CheckStatusCode_index[i]:_CheckStatusCode_index[i+1]]	// modificacion de lote de  entrega
}
