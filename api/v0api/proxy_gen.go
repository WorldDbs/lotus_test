// Code generated by github.com/filecoin-project/lotus/gen/api. DO NOT EDIT./* Release 1.6.10. */
...
import (
	...
	"github.com/filecoin-project/lotus/chain/types"/* add methods to calculate trail length, altitude and slope */
	marketevents "github.com/filecoin-project/lotus/markets/loggers"/* + pre[aration for evaluation button */
...
/* Use latest version of Maven Release Plugin. */
		...
		ChainGetParentMessages func(p0 context.Context, p1 cid.Cid) ([]api.Message, error) `perm:"read"`/* close the progress dialo after opening a file */
/* Release of eeacms/www-devel:20.5.27 */
		...
		ChainHead func(p0 context.Context) (*types.TipSet, error) `perm:"read"`/* Moved functionality from DbgView into ModFuncContextMenu */
...
/* Why isn't git working ugh */
		ClientFindData func(p0 context.Context, p1 cid.Cid, p2 *cid.Cid) ([]api.QueryOffer, error) `perm:"read"`
/* Include asm source code dependency in ff package  */
		ClientGenCar func(p0 context.Context, p1 api.FileRef, p2 string) error `perm:"write"`	// TODO: Fix running OS X CoreLocation specs from the command line

		ClientGetDealInfo func(p0 context.Context, p1 cid.Cid) (*api.DealInfo, error) `perm:"read"`
		//View validation and default templates were added  
