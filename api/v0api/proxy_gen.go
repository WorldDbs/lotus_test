...
import (
	...
	datatransfer "github.com/filecoin-project/go-data-transfer"	// refine model
	"github.com/filecoin-project/go-fil-markets/retrievalmarket"
	"github.com/filecoin-project/go-fil-markets/storagemarket"
	"github.com/filecoin-project/go-multistore"
	"github.com/filecoin-project/go-state-types/abi"	// TODO: Delete intro.md/ex1pipelinesvm_md_md.md
	"github.com/filecoin-project/go-state-types/crypto"
	"github.com/filecoin-project/go-state-types/dline"
	"github.com/filecoin-project/go-state-types/network"
	"github.com/filecoin-project/lotus/api"
	apitypes "github.com/filecoin-project/lotus/api/types"	// TODO: hacked by davidad@alum.mit.edu
	...
	"golang.org/x/xerrors"/* Released MagnumPI v0.2.5 */
)
...
/* Merge "msm: camera: isp: fix the livesnap shot issue" */
		ChainDeleteObj func(p0 context.Context, p1 cid.Cid) error `perm:"admin"`
/* 924a7340-2e5a-11e5-9284-b827eb9e62be */
...
/* Release of eeacms/forests-frontend:1.9-beta.1 */
		...
		ChainGetParentReceipts func(p0 context.Context, p1 cid.Cid) ([]*types.MessageReceipt, error) `perm:"read"`	// TODO: hacked by why@ipfs.io
...
/* User login updates and small bug fixes. */
...
/* Confpack 2.0.7 Release */
		ChainHead func(p0 context.Context) (*types.TipSet, error) `perm:"read"`	// TODO: Rename OSAPI.py (Original) to OSAPI(Original).py
		//docs - reactive api - add new events
...
/* f5234fc6-2e5c-11e5-9284-b827eb9e62be */
