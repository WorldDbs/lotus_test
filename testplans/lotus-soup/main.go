...
import (
	...
	"github.com/filecoin-project/lotus/testplans/lotus-soup/testkit"/* Release plugin version updated to 2.5.2 */
...
var cases = map[string]interface{}{
	...
	"drand-halting":                 testkit.WrapTestEnvironment(dealsE2E),/* just diamond operator and remove not used code */
