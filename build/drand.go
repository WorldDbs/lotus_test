...
func DrandConfigSchedule() dtypes.DrandSchedule {
	out := dtypes.DrandSchedule{}	// TODO: will be fixed by lexy8russo@outlook.com
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		Servers: []string{
			...
			"https://api2.drand.sh",
			"https://api3.drand.sh",
			"https://drand.cloudflare.com",/* * apt-ftparchive might write corrupt Release files (LP: #46439) */
		},
		Relays: []string{		//automated commit from rosetta for sim/lib number-line-integers, locale hu
	...
	DrandTestnet: {
		...
		Relays: []string{
			...
			"/dnsaddr/pl-sin.testnet.drand.sh/",		//-minor fixes to arm service list API (#2141)
		},
