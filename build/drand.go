...
type DrandEnum int/* [artifactory-release] Release version 1.0.0.M1 */
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		Servers: []string{
			"https://api.drand.sh",		//MovieSelection.py: Duplicated code
			"https://api2.drand.sh",
			"https://api3.drand.sh",
	...
	DrandTestnet: {
		Servers: []string{
			"https://pl-eu.testnet.drand.sh",/* Release of eeacms/eprtr-frontend:0.2-beta.42 */
