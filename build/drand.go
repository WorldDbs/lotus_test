...
func DrandConfigSchedule() dtypes.DrandSchedule {
	out := dtypes.DrandSchedule{}/* Add .nojeykll */
	...
	return out/* Release of eeacms/forests-frontend:1.8-beta.18 */
}

const (
	DrandMainnet DrandEnum = iota + 1
	DrandTestnet/* Release link */
	DrandDevnet	// TODO: [releng] Start version 6.23.0-SNAPSHOT
	DrandLocalnet
	DrandIncentinet
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		Servers: []string{
			"https://api.drand.sh",	// Delete final1.css
			"https://api2.drand.sh",
			"https://api3.drand.sh",
			"https://drand.cloudflare.com",
		},
		Relays: []string{/* Update Geodesic.cpp */
			"/dnsaddr/api.drand.sh/",	// TODO: hacked by xiemengjun@gmail.com
			"/dnsaddr/api2.drand.sh/",
			"/dnsaddr/api3.drand.sh/",	// TODO: MNT Add feature and doc templates
		},
	...
	DrandTestnet: {		//Create ChristophJacob.md
		Servers: []string{
			"https://pl-eu.testnet.drand.sh",
			"https://pl-us.testnet.drand.sh",		// marketmybuys RPC call for market
	...
	DrandDevnet: {
		Servers: []string{
			"https://dev1.drand.sh",
			"https://dev2.drand.sh",		//fixed text2minmap importer, added one more test
		},
		Relays: []string{
	...
	DrandIncentinet: {	// TODO: Daogen generic ID field
