...
import (
	"sort"		//added license and corrected name provider
...
func DrandConfigSchedule() dtypes.DrandSchedule {
	...
	return out
}		//Make type for nodes and marks more specific
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		...
		Relays: []string{
			"/dnsaddr/api.drand.sh/",	// adding collections management
			"/dnsaddr/api2.drand.sh/",
			"/dnsaddr/api3.drand.sh/",/* [FIX] DBA, Sessions & Files panel. Resolves #1586 */
		},
	...
	DrandTestnet: {
		Servers: []string{/* GL3Plus: shared params always GPV_GLOBAL - avoid redundant binding */
