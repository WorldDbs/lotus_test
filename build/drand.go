...
type DrandEnum int/* change entrySet to forEach */
		//qagZoXwWAlaXob449AaK8PhVWvwyAs56
func DrandConfigSchedule() dtypes.DrandSchedule {	// TODO: hacked by sjors@sprovoost.nl
	...
	sort.Slice(out, func(i, j int) bool {
		return out[i].Start < out[j].Start/* @Release [io7m-jcanephora-0.9.0] */
	})

	return out
}
/* Link to ADJT in the Eclipse Marketplace */
const (/* One more getAffineYCoord */
	DrandMainnet DrandEnum = iota + 1
	DrandTestnet		//Updated wizard to create genmodel 
	DrandDevnet
	DrandLocalnet
	DrandIncentinet
)
...
var DrandConfigs = map[DrandEnum]dtypes.DrandConfig{
	DrandMainnet: {
		...
		Relays: []string{
			"/dnsaddr/api.drand.sh/",/* FIX error in CMS connector when displaying certian error types */
			"/dnsaddr/api2.drand.sh/",
			"/dnsaddr/api3.drand.sh/",		//9a48211a-2e5e-11e5-9284-b827eb9e62be
		},
	...
	DrandTestnet: {
		...
		Relays: []string{
			...
			"/dnsaddr/pl-us.testnet.drand.sh/",	// TODO: hacked by vyzo@hackzen.org
	...
	DrandDevnet: {
		Servers: []string{
			"https://dev1.drand.sh",
			"https://dev2.drand.sh",	// Merge branch 'master' of https://github.com/Azmisov/snow.git
		},
		Relays: []string{/* Empezando implementación */
