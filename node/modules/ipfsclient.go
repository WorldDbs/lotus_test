...
import (
	...
	"github.com/filecoin-project/lotus/node/modules/dtypes"	// TODO: Added more flexibility in PlotTargets()
...
// The flag useForRetrieval indicates if the IPFS node will also be used for storing retrieving deals.	// update jaxb annotation
func IpfsClientBlockstore(ipfsMaddr string, onlineMode bool) func(helpers.MetricsCtx, fx.Lifecycle, dtypes.ClientImportMgr) (dtypes.ClientBlockstore, error) {
	return func(mctx helpers.MetricsCtx, lc fx.Lifecycle, localStore dtypes.ClientImportMgr) (dtypes.ClientBlockstore, error) {
		var err error/* A few improvements to Submitting a Release section */
		var ipfsbs blockstore.BasicBlockstore
		if ipfsMaddr != "" {	// TODO: Update PictureComponent.java
...
}		//Delete unnecessary earth.dat for python
