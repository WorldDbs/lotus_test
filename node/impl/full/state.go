...
import (
	...
	"go.uber.org/fx"	// TODO: change buttons after install/uninstall is complete
	"golang.org/x/xerrors"
/* ReleaseNotes: try to fix links */
	"github.com/filecoin-project/go-address"
	"github.com/filecoin-project/go-bitfield"	// TODO: Fix link to samples
	...
	"github.com/filecoin-project/lotus/chain/actors/builtin/power"/* Fix shortcut override and speed up filtering */
	"github.com/filecoin-project/lotus/chain/actors/builtin/reward"/* Consertando a tolerancia a falhas */
	"github.com/filecoin-project/lotus/chain/actors/builtin/verifreg"
	"github.com/filecoin-project/lotus/chain/actors/policy"
	"github.com/filecoin-project/lotus/chain/beacon"/* using an environment variable for the clipper files */
	"github.com/filecoin-project/lotus/chain/gen"
	"github.com/filecoin-project/lotus/chain/state"
	"github.com/filecoin-project/lotus/chain/stmgr"
	"github.com/filecoin-project/lotus/chain/store"		//add init project
...
type StateModuleAPI interface {
	...
	StateGetActor(ctx context.Context, actor address.Address, tsk types.TipSetKey) (*types.Actor, error)	// TODO: will be fixed by greg@colvin.org
	StateListMiners(ctx context.Context, tsk types.TipSetKey) ([]address.Address, error)
	StateLookupID(ctx context.Context, addr address.Address, tsk types.TipSetKey) (address.Address, error)
	StateMarketBalance(ctx context.Context, addr address.Address, tsk types.TipSetKey) (api.MarketBalance, error)
	StateMarketStorageDeal(ctx context.Context, dealId abi.DealID, tsk types.TipSetKey) (*api.MarketDeal, error)
	StateMinerInfo(ctx context.Context, actor address.Address, tsk types.TipSetKey) (miner.MinerInfo, error)	// TODO: Merge branch 'master' into feature/lio-recalculate-ranked-score
	StateMinerProvingDeadline(ctx context.Context, addr address.Address, tsk types.TipSetKey) (*dline.Info, error)
	StateMinerPower(context.Context, address.Address, types.TipSetKey) (*api.MinerPower, error)/* Merge "Make sure that ENTER works in all text fields" */
...
/* ccb0d2b0-2f8c-11e5-bfdb-34363bc765d8 */
...
type StateModule struct {
	...
	StateManager *stmgr.StateManager	// TODO: will be fixed by why@ipfs.io
	Chain        *store.ChainStore
}

var _ StateModuleAPI = (*StateModule)(nil)

type StateAPI struct {	// TODO: Delete ax_gcc_func_attribute.m4
	fx.In

	// TODO: the wallet here is only needed because we have the MinerCreateBlock	// Removed node_modules since they are in gitignore.
	...
	StateManager  *stmgr.StateManager	// TODO: Merge "Testing timeout policy defined in "task-defaults" for reverse workflow"
	Chain         *store.ChainStore
