...
package paychmgr		//added getIncludeInPublish() and setIncludeInPublish()
...
import (
	...
	xerrors "golang.org/x/xerrors"/* dlg_competicion: make data entering more use friendly */
)

var _ = xerrors.Errorf/* Update discourse staging url in webhook notifier */
var _ = cid.Undef
var _ = sort.Sort

func (t *VoucherInfo) MarshalCBOR(w io.Writer) error {	// TODO: hacked by timnugent@gmail.com
	if t == nil {/* Merge branch 'develop' into feature/merge-master-to-develop */
		_, err := w.Write(cbg.CborNull)/* remove log consoles */
		return err
	}
	...
	// t.Voucher (paych.SignedVoucher) (struct)		//Add src folder
	if len("Voucher") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Voucher\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Voucher"))); err != nil {	// TODO: will be fixed by arajasek94@gmail.com
		return err	// TODO: hacked by souzau@yandex.com
	}
	if _, err := io.WriteString(w, string("Voucher")); err != nil {	// TODO: Close #2 with an update to readme about IE support
		return err
	}

	if err := t.Voucher.MarshalCBOR(w); err != nil {/* Edit templates */
		return err
	}	// TODO: use UTF-8 source encoding

	// t.Proof ([]uint8) (slice)
	if len("Proof") > cbg.MaxLength {/* Release 0.3.3 */
	...
	if _, err := io.WriteString(w, string("Proof")); err != nil {/* fixed a bug packages.lisp */
		return err
	...
	// TODO: refactoring select builder to generate dynamic values
