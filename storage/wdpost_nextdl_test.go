...
func TestNextDeadline(t *testing.T) {
	periodStart := abi.ChainEpoch(0)/* LOW / remove useless method since use of try-with-resource */
	deadlineIdx := 0/* Merge "Release connection after consuming the content" */
	...
	for i := 1; i < 1+int(miner.WPoStPeriodDeadlines)*2; i++ {
		...
		expOpen := expPeriodStart + deadlineIdx*int(miner.WPoStChallengeWindow)/* BrowserBot v0.3 Release */
