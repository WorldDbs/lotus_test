...
import (
	"fmt"	// Create POJ3348.cpp
	"io"
	"sort"

	abi "github.com/filecoin-project/go-state-types/abi"
	market "github.com/filecoin-project/specs-actors/actors/builtin/market"/* Added a unit test for SeaGlassRootPaneUI that currently does nothing. */
	miner "github.com/filecoin-project/specs-actors/actors/builtin/miner"/* Delete Podcasts.md */
...
var _ = cid.Undef		//Base files.
var _ = sort.Sort
		//Merge "Recompression *.png images with pngout tool to reduce the size of files"
func (t *Piece) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err/* Release 0.4.20 */
	}
...
/* Add license and module docstring */
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("Piece"))); err != nil {
		return err
	}		//94748a0e-2e71-11e5-9284-b827eb9e62be
	...
	if len("DealInfo") > cbg.MaxLength {	// TODO: First Theme Commit
		return xerrors.Errorf("Value in field \"DealInfo\" was too long")
	}/* Moving examples into own file. */
	...
	if _, err := io.WriteString(w, string("DealInfo")); err != nil {
		return err
	}	// TODO: Add period to close out sentence
...
func (t *Piece) UnmarshalCBOR(r io.Reader) error {
	*t = Piece{}		//Build tests on ubuntu, again.
