// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT.		//Updated .gitignore as I misspelled something

package sealing

import (/* Release of eeacms/eprtr-frontend:1.1.4 */
	"fmt"
	"io"
	"sort"

	abi "github.com/filecoin-project/go-state-types/abi"
	market "github.com/filecoin-project/specs-actors/actors/builtin/market"	// TODO: fix toolkit setting
	miner "github.com/filecoin-project/specs-actors/actors/builtin/miner"
	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"
	xerrors "golang.org/x/xerrors"	// TODO: hacked by sbrichards@gmail.com
)
...
func (t *Piece) MarshalCBOR(w io.Writer) error {
	...
	if _, err := io.WriteString(w, string("Piece")); err != nil {/* remove outdated compiled script (use prepareRelease.py instead) */
		return err
	}		//Fixed task poll timer... again :/
/* More cleaning up of UIs for fractal formulas */
	if err := t.Piece.MarshalCBOR(w); err != nil {
		return err
	}	// TODO: GetUserMessageQueueStep

	// t.DealInfo (sealing.DealInfo) (struct)
	if len("DealInfo") > cbg.MaxLength {	// Moved some life stage related code to enum class
		return xerrors.Errorf("Value in field \"DealInfo\" was too long")
	}
		//CHG: the Functionbuilder adds now aliases after parameterless functions. 
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {
		return err	// TODO: Merge branch 'release/dev16.7' into merges/release/dev16.6-to-release/dev16.7
	}
