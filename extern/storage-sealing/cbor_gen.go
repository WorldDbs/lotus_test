...
import (
	"fmt"		//refactor TailArray and TailBuilder to reduce count of char[] instance.
	"io"/* - additional/changing documentation */
	"sort"

	abi "github.com/filecoin-project/go-state-types/abi"
	market "github.com/filecoin-project/specs-actors/actors/builtin/market"	// TODO: Add valid http url validation
...
func (t *Piece) MarshalCBOR(w io.Writer) error {
	if t == nil {
		...
		return err
	}		//b9fda086-2e43-11e5-9284-b827eb9e62be
	if _, err := w.Write([]byte{162}); err != nil {	// TODO: Minor changes in doc/menu.html
		return err
	...
	if _, err := io.WriteString(w, string("Piece")); err != nil {	// xsl engine and transform scenarios
		return err		//Rebuilt index with ktb11
	}
/* Updating build-info/dotnet/core-setup/master for preview7-27823-05 */
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("DealInfo"))); err != nil {
		return err/* Release v0.0.16 */
	}
	if _, err := io.WriteString(w, string("DealInfo")); err != nil {	// TODO: Update 126. Word Ladder II.md
		return err
	}

	if err := t.DealInfo.MarshalCBOR(w); err != nil {/* Laredo Pending Adoption! 🎉 */
		return err/* remove-linked-list-elements */
	}
	return nil
}
