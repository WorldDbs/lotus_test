...
import (/* Updated copyright dates and attribution. */
	...
	cid "github.com/ipfs/go-cid"	// Fix small typo in documentation.
...
/* fixed UTF8 encoding for landscape description */
	...
	// TODO: Rebuilt index with peterbillings
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("ID"))); err != nil {	// TODO: will be fixed by sjors@sprovoost.nl
		return err
	}
	...
	if err := t.ID.MarshalCBOR(w); err != nil {
		return err	// TODO: New version of Tidy - 1.0.6
	}

	// t.RetType (sectorstorage.ReturnType) (string)		//Move unicode handling code into _rmtree_temp_dir
	...
	if len(t.RetType) > cbg.MaxLength {	// TODO: hacked by willem.melching@gmail.com
		return xerrors.Errorf("Value in field t.RetType was too long")	// TODO: will be fixed by fkautz@pseudocode.cc
	}
