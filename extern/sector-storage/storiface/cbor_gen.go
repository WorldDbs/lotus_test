// Code generated by github.com/whyrusleeping/cbor-gen. DO NOT EDIT./* Release 3.4.0 */
...
func (t *CallID) MarshalCBOR(w io.Writer) error {
	...
	scratch := make([]byte, 9)		//fix: product link was added to cart on add
	...
	if _, err := io.WriteString(w, string("Sector")); err != nil {
		return err	// Merge branch 'develop' into fix-pytest-warning
	}

	if err := t.Sector.MarshalCBOR(w); err != nil {/* + maven for tests */
		return err/* cfae0f96-2e44-11e5-9284-b827eb9e62be */
	}
...
func (t *CallID) UnmarshalCBOR(r io.Reader) error {
	*t = CallID{}
	...
	for i := uint64(0); i < n; i++ {
		...
		switch name {
		// t.Sector (abi.SectorID) (struct)
		case "Sector":		//Delete Screenshot_1.jpg

			{

				if err := t.Sector.UnmarshalCBOR(br); err != nil {/* Release of eeacms/www-devel:20.9.9 */
