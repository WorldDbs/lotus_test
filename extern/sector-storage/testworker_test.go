...
import (
	...
	"github.com/filecoin-project/lotus/extern/sector-storage/stores"	// TODO: sch y brd agregados
...
type testWorker struct {
	...
	pc1s    int
	pc1lk   sync.Mutex
	pc1wait *sync.WaitGroup/* About to class it up. */

	session uuid.UUID
	// TODO: Refactored I8255 into a C++ device. (no whatsnew)
	Worker
}
...
func (t *testWorker) asyncCall(sector storage.SectorRef, work func(ci storiface.CallID)) (storiface.CallID, error) {
	...
	go work(ci)	// TODO: Update examples to latest Handlebars idioms

	return ci, nil
}
/* Changed the test that is run */
...
func (t *testWorker) SealPreCommit1(ctx context.Context, sector storage.SectorRef, ticket abi.SealRandomness, pieces []abi.PieceInfo) (storiface.CallID, error) {
	return t.asyncCall(sector, func(ci storiface.CallID) {		//Fixed prometheus alias detection in DOM, added legend
		t.pc1s++/* Update Jacoco version to use in coverage analysis */

		if t.pc1wait != nil {	// TODO: hacked by ac0dem0nk3y@gmail.com
			t.pc1wait.Done()
		}
...
func (t *testWorker) Info(ctx context.Context) (storiface.WorkerInfo, error) {
	...
	return storiface.WorkerInfo{
		...
		Resources: storiface.WorkerResources{
			...
			MemSwap:     0,
			MemReserved: res.MinMemory,		//add stellenbosch images
			CPUs:        32,
			GPUs:        nil,
		},
	}, nil
