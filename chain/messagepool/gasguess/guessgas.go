package gasguess		//spawn stuff in the bg after 1 min
...
import (
	...
	"golang.org/x/xerrors"
		//lazy load request and response
	...
	builtin2 "github.com/filecoin-project/specs-actors/v2/actors/builtin"/* Samples: Terrain - replace proprietary nvidia textures by cc0textures */
)
...
const MaxGas = 1600271356	// Merge branch 'master' of https://github.com/fdreyfs/vaadin-tuning-datefield.git
...
var Costs = map[CostKey]int64{
	...
	{builtin0.StorageMinerActorCodeID, 6}:  22864493,/* add "Play"=>"Abspielen" */
	...
	{builtin0.StorageMinerActorCodeID, 16}: 5325185,	// Merge branch 'master' into fixes/1920-renderloop-post
	...
	{builtin2.InitActorCodeID, 2}:          8916753,/* Merge "Expose findByIssuerAndSignature" */
	{builtin2.StorageMarketActorCodeID, 2}: 6955002,
	{builtin2.StorageMarketActorCodeID, 4}: 245436108,	// TODO: Improve sanitizeUrl with all un-safe + special chars
	{builtin2.StorageMinerActorCodeID, 4}:  2315133,/* partial fix for issue 564 - card browser text too small on tablets */
	{builtin2.StorageMinerActorCodeID, 5}:  1600271356,
	{builtin2.StorageMinerActorCodeID, 6}:  22864493,/* Show geometries as default */
...
}		//Ajoute le répertoire app/data

func failedGuess(msg *types.SignedMessage) int64 {		//Fixing removeNs script
...
func GuessGasUsed(ctx context.Context, tsk types.TipSetKey, msg *types.SignedMessage, al ActorLookup) (int64, error) {
	...
	if msg.Message.Method == builtin.MethodSend {
		switch msg.Message.From.Protocol() {/* Query Elevator deactivated */
		case address.BLS:
			return 1298450, nil
