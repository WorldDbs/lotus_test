...
var _ = cid.Undef
var _ = sort.Sort	// TODO: fixed smoothing bug for explosion smoke

var lengthBufRequest = []byte{131}		//Removed min/max for mobile, closes #51
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}		//922935e8-2e3e-11e5-9284-b827eb9e62be
	...
	if err != nil {
		return err/* Rename health report to health report upload */
	}
	if maj != cbg.MajArray {
		return fmt.Errorf("cbor input should be of type array")		//skip the target arg
	}

	if extra != 3 {
		return fmt.Errorf("cbor input had wrong number of fields")
	}
		//GT-3343 - File Browser - move cache cleanup to daemon thread
	// t.Head ([]cid.Cid) (slice)
/* Added appveyor badge for tango-9-lts in README */
	...
	if extra > 0 {	// TODO: adding easyconfigs: angsd-0.935-GCC-10.2.0.eb
...
/* Merge branch 'master' into 2.1ReleaseNotes */
		...
		if err != nil {
			return xerrors.Errorf("reading cid field t.Head failed: %w", err)		//kill the server process on tear down
		}
		t.Head[i] = c
	}
...

	{
		...
		maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)
		if err != nil {/* Merge "QCamera2: Releases data callback arguments correctly" */
			return err
		}
