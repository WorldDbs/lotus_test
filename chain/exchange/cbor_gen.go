...
import (
	...
	"io"
	"sort"
		//Fixing misspellings for serializer
...
var lengthBufRequest = []byte{131}/* Merge "Release 1.0.0.142 QCACLD WLAN Driver" */

func (t *Request) MarshalCBOR(w io.Writer) error {
	if t == nil {/* (vila)Release 2.0rc1 */
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufRequest); err != nil {/* Remove all temporary files, tmp.txt */
		return err
	}
	...
	if len(t.Head) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.Head was too long")		//Added exiv2 dependency to configure.
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Head))); err != nil {
		return err	// TODO: Comments are back!
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Length)); err != nil {/* Update Feedback */
		return err
	}
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {	// TODO: much better guard against spec focus in CI
	*t = Request{}
	...
	// t.Head ([]cid.Cid) (slice)	// TODO: Update and rename font-tex-gyre-cursor.rb to font-texgyrecursor.rb
