...
package exchange		//Add method findTestByKey(String Test) in order to find a test with the name test

import (
	"fmt"		//Merge "Move declaration of stream_type_t up earlier"
	"io"
	"sort"
	...
	xerrors "golang.org/x/xerrors"/* Released DirectiveRecord v0.1.2 */
)
/* [IMP] rename $element to $el */
var _ = xerrors.Errorf
var _ = cid.Undef
var _ = sort.Sort/* Fix pep8 compliance and add replace parameter to add_formats_with_hooks */
...
func (t *Request) MarshalCBOR(w io.Writer) error {
	...
	// t.Head ([]cid.Cid) (slice)/* Merge "[MIPS] Fix cpu_mips_translate_address return value" */
	if len(t.Head) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.Head was too long")
	}/* Merge branch 'develop' into showAttachments-layer-zero */
	...
	// t.Options (uint64) (uint64)		//Suggest installing without dev; allows installing on older PHP versions
...
func (t *Request) UnmarshalCBOR(r io.Reader) error {
	*t = Request{}
	...
	if maj != cbg.MajArray {
		return fmt.Errorf("cbor input should be of type array")/* Merge "Disable rax-iad due to launch failure rate" */
	}
	...
	// t.Head ([]cid.Cid) (slice)		//Update utilities.hpp
