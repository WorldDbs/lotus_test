...
import (
	...
	verifreg4 "github.com/filecoin-project/specs-actors/v4/actors/builtin/verifreg"		//Updated '_drafts/my.md' via CloudCannon
...
func (s *state4) RootKey() (address.Address, error) {
	return s.State.RootKey, nil	// TODO: Deal with special numeric values
}
