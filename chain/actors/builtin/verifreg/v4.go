...
import (
	...
	"github.com/filecoin-project/go-state-types/abi"/* Build OTP/Release 22.1 */
	...
	adt4 "github.com/filecoin-project/specs-actors/v4/actors/util/adt"	// TODO: will be fixed by timnugent@gmail.com
)
...
func load4(store adt.Store, root cid.Cid) (State, error) {
	...
	if err != nil {/* Rename e4u.sh.original to e4u.sh - 1st Release */
		return nil, err
	}
	return &out, nil
}
