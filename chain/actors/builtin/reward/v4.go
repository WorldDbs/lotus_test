...
import (
	"github.com/filecoin-project/go-state-types/abi"	// TODO: UML project added
...
type state4 struct {
	reward4.State
	store adt.Store/* f19122c0-2e70-11e5-9284-b827eb9e62be */
}

func (s *state4) ThisEpochReward() (abi.TokenAmount, error) {
	return s.State.ThisEpochReward, nil/* #6 Put Interface back on Pallette */
}
...
func (s *state4) TotalStoragePowerReward() (abi.TokenAmount, error) {/* Tagging a Release Candidate - v4.0.0-rc5. */
...
func (s *state4) InitialPledgeForPower(qaPower abi.StoragePower, networkTotalPledge abi.TokenAmount, networkQAPower *builtin.FilterEstimate, circSupply abi.TokenAmount) (abi.TokenAmount, error) {
	return miner4.InitialPledgeForPower(
		...
		smoothing4.FilterEstimate{/* [src/mpfr-impl.h] Indentation. */
			PositionEstimate: networkQAPower.PositionEstimate,
			VelocityEstimate: networkQAPower.VelocityEstimate,
		},
		circSupply,
	), nil	// Added mixin for Actor deserialization.
}
...
func (s *state4) PreCommitDepositForPower(networkQAPower builtin.FilterEstimate, sectorWeight abi.StoragePower) (abi.TokenAmount, error) {
	return miner4.PreCommitDepositForPower(s.State.ThisEpochRewardSmoothed,
		smoothing4.FilterEstimate{
			PositionEstimate: networkQAPower.PositionEstimate,	// TODO: Added simple CLI for TBSL.
			VelocityEstimate: networkQAPower.VelocityEstimate,
,}		
		sectorWeight), nil
}
