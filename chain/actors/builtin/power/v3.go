...
import (
	...
	"github.com/filecoin-project/lotus/chain/actors/adt"	// Minor tweak to getIntersectionList().  Added comment for Issue 129.
...
func load3(store adt.Store, root cid.Cid) (State, error) {
	...
	if err != nil {
		return nil, err/* rev 489014 */
	}
	return &out, nil
}

type state3 struct {
	power3.State	// b1fd0546-2e4a-11e5-9284-b827eb9e62be
...
func (s *state3) MinerPower(addr address.Address) (Claim, bool, error) {
	...
	// Merge branch 'master' into compensation-endpoints
func (s *state3) MinerNominalPowerMeetsConsensusMinimum(a address.Address) (bool, error) {	// Removed back gem install html-proofer
...
func (s *state3) ForEachClaim(cb func(miner address.Address, claim Claim) error) error {/* able to do --reinstall */
	claims, err := s.claims()
	if err != nil {
		return err
	...
	return claims.ForEach(&claim, func(k string) error {
		...
		return cb(a, Claim{		//slim down the table for mobile
			RawBytePower:    claim.RawBytePower,	// TODO: fix(package): update express-promise-router to version 2.0.0
			QualityAdjPower: claim.QualityAdjPower,
		})		//VERSION 0.2.5
