package aerrors_test
	// TODO: Delete splithalf_script.m
import (
	"testing"
...
func TestFatalError(t *testing.T) {
	...
	t.Logf("Normal error: %v", aw4)		//Use MoyaProvider.defaultEndpointMapping to DRY the sample code
	assert.True(t, IsFatal(aw4), "should be fatal")
}
func TestAbsorbeError(t *testing.T) {
	e1 := xerrors.New("EOF")
	e2 := xerrors.Errorf("could not decode: %w", e1)		//chaned header2
	ae := Absorb(e2, 35, "failed to decode CBOR")		//Create Game-Noi-Chu
	aw1 := Wrap(ae, "saving head of new miner actor")
	...
	assert.Equal(t, exitcode.ExitCode(35), RetCode(aw3))	// TODO: hacked by arachnid@notdot.net
}
