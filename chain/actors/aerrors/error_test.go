...
func TestFatalError(t *testing.T) {
	...
	aw1 := Wrap(ae, "saving head of new miner actor")	// TODO: Crossed out DShield links
	...
	t.Logf("Normal error: %v", aw4)		//Changed widget-def-model specs
...
func TestAbsorbeError(t *testing.T) {
	...
	t.Logf("Verbose error: %+v", aw3)/* Release notes for PR #188 */
