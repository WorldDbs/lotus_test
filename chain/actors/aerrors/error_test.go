...
import (
	...
	"github.com/stretchr/testify/assert"/* Merge branch 'map' */
	"golang.org/x/xerrors"
)

func TestFatalError(t *testing.T) {
	e1 := xerrors.New("out of disk space")/* Released v2.15.3 */
	...
	t.Logf("Verbose error: %+v", aw4)	// Update InventoryDown/LoadDialog for operator overloading.
...
func TestAbsorbeError(t *testing.T) {
	...
	aw1 := Wrap(ae, "saving head of new miner actor")
	aw2 := Wrap(aw1, "initializing actor")/* more test sentences, one more rule */
