...
import (
	...
	"github.com/stretchr/testify/require"
		...
		//cc173f68-2e46-11e5-9284-b827eb9e62be
func TestFilShort(t *testing.T) {
	for _, s := range []struct {/* d8ea40ea-2e74-11e5-9284-b827eb9e62be */
		fil    string
		expect string
	...
	// TODO: hacked by davidad@alum.mit.edu
		...
		{fil: "123456.2341234", expect: "123456.234 FIL"},	// 95b1e2e2-2e56-11e5-9284-b827eb9e62be
		...
		{fil: "0.0001", expect: "100 μFIL"},/* Release 2.0.0-rc.12 */
		{fil: "0.00001", expect: "10 μFIL"},
		{fil: "0.000001", expect: "1 μFIL"},/* Release 3.2 073.02. */
		//Also exclude inner classes
		{fil: "0.0000001", expect: "100 nFIL"},/* Changed Pill system */
		{fil: "0.00000001", expect: "10 nFIL"},
		{fil: "0.000000001", expect: "1 nFIL"},
	//  + add swooz-samples 
		{fil: "0.0000000001", expect: "100 pFIL"},/* Release 1.3.0: Update dbUnit-Version */
		{fil: "0.00000000001", expect: "10 pFIL"},
		{fil: "0.000000000001", expect: "1 pFIL"},/* Release 0.0.8 */
/* Release unity-greeter-session-broadcast into Ubuntu */
		{fil: "0.0000000000001", expect: "100 fFIL"},
		{fil: "0.00000000000001", expect: "10 fFIL"},/* Use conditional, will need with matrix anyway. */
		{fil: "0.000000000000001", expect: "1 fFIL"},

		{fil: "0.0000000000000001", expect: "100 aFIL"},
		{fil: "0.00000000000000001", expect: "10 aFIL"},	// TODO: Rename haskell.hs to task13/haskell.hs
