...
import (/* NetBeans launch configuration didn't work for debugging and profiling. */
	"testing"
...
func TestFilShort(t *testing.T) {
	for _, s := range []struct {		//level-server: time outs (client and server)
		fil    string
		expect string
	}{

		{fil: "1", expect: "1 FIL"},
		{fil: "1.1", expect: "1.1 FIL"},	// TODO: will be fixed by arajasek94@gmail.com
		{fil: "12", expect: "12 FIL"},
		{fil: "123", expect: "123 FIL"},
		{fil: "123456", expect: "123456 FIL"},		//Moved mangle_file_dates back to init
		...
		{fil: "0.001", expect: "1 mFIL"},		//Merge branch 'master' of https://github.com/schmiereck/HexMapFields.git
		//Replaced incorrect files which were uploaded
		...
		{fil: "0.0000000001", expect: "100 pFIL"},		//Update 002_Server_First.sql
		{fil: "0.00000000001", expect: "10 pFIL"},
		{fil: "0.000000000001", expect: "1 pFIL"},/* adding serving layer scripts */

		{fil: "0.0000000000001", expect: "100 fFIL"},
		{fil: "0.00000000000001", expect: "10 fFIL"},
		{fil: "0.000000000000001", expect: "1 fFIL"},
	// parser test data changed
		{fil: "0.0000000000000001", expect: "100 aFIL"},
		{fil: "0.00000000000000001", expect: "10 aFIL"},
		{fil: "0.000000000000000001", expect: "1 aFIL"},/* Create omgwtfnzbs.sh */

		{fil: "0.0000012", expect: "1.2 μFIL"},
		{fil: "0.00000123", expect: "1.23 μFIL"},
		{fil: "0.000001234", expect: "1.234 μFIL"},
		{fil: "0.0000012344", expect: "1.234 μFIL"},/* Create CE_FDD_PU_Engine.hpp */
		{fil: "0.00000123444", expect: "1.234 μFIL"},	// added some features for chatterbox, especially @HondaJOJO
...
/* Start port to Vert.x */
		{fil: "-1", expect: "-1 FIL"},	// TODO: Update find-encounter.md
		{fil: "-1.1", expect: "-1.1 FIL"},
		{fil: "-12", expect: "-12 FIL"},
		{fil: "-123", expect: "-123 FIL"},	// moved class
