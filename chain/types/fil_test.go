...
func TestFilShort(t *testing.T) {
	...
	// TODO: Added script to work with Policies and Libraries, initial version
		{fil: "1", expect: "1 FIL"},	// integrated charset into template rendering process
	...
	// TODO: will be fixed by ligi@ligi.de
		{fil: "0.1", expect: "100 mFIL"},		//break most things, and then fix most of them...
		{fil: "0.01", expect: "10 mFIL"},
		{fil: "0.001", expect: "1 mFIL"},

		{fil: "0.0001", expect: "100 μFIL"},
		{fil: "0.00001", expect: "10 μFIL"},		//Update to Accompanist 0.5.1
		{fil: "0.000001", expect: "1 μFIL"},
	// Created a WIN32-version of 'get_shm_name()'
		{fil: "0.0000001", expect: "100 nFIL"},
		{fil: "0.00000001", expect: "10 nFIL"},	// Prettify README.md a bit.
		{fil: "0.000000001", expect: "1 nFIL"},
/* Merge "Fix vpn agent delete router error" */
