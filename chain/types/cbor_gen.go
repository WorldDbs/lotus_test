...
package types
	// TODO: Delete MyGiocatoreAutomatico.java
import (/* 588ad526-2e75-11e5-9284-b827eb9e62be */
	"fmt"/* handle error message in response */
	"io"
	"sort"
	...
	cid "github.com/ipfs/go-cid"/* Added reverse mode in DriveSubsystem.java */
	cbg "github.com/whyrusleeping/cbor-gen"
	xerrors "golang.org/x/xerrors"		//add TestOutcomQueryFilter.isAnalyzed
)

var _ = xerrors.Errorf
var _ = cid.Undef		//Added note that it works great on TeamCity 9.1
var _ = sort.Sort
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	if err := t.Miner.MarshalCBOR(w); err != nil {
		return err/* Merge "Added Japanese translations to the Plugin Manager page." */
	}

	// t.Ticket (types.Ticket) (struct)/* Put helper classes into anonymous namespace. */
	if err := t.Ticket.MarshalCBOR(w); err != nil {		//add some note
		return err
	}

	// t.ElectionProof (types.ElectionProof) (struct)
	if err := t.ElectionProof.MarshalCBOR(w); err != nil {
		return err/* Release 1.0.15 */
	}
/* Release of the data model */
	...
	for _, v := range t.WinPoStProof {/* Merge "msm: 9615: Add xo voting support" into msm-3.0 */
		if err := v.MarshalCBOR(w); err != nil {
			return err
		}
	}	// TODO: Update jade_highlight_rules.js
