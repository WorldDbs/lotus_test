...
package types
		//Merge "handle_clear_netboot needs to be per-architecture" into develop
import (
	"fmt"
	"io"
	"sort"
	...
	cbg "github.com/whyrusleeping/cbor-gen"		//Forgot the Call command for the function
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufBlockHeader); err != nil {/* fix https://github.com/AdguardTeam/AdguardFilters/issues/69350 */
		return err
	}
	...
	if err := t.Miner.MarshalCBOR(w); err != nil {		//Now working with Spring security login
		return err
	}
	...
	if err := t.ElectionProof.MarshalCBOR(w); err != nil {/* Replace 'japaneseOrder' by 'rightToLeft' */
		return err/* Library folder added with for prototype needed jar libs */
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.BeaconEntries))); err != nil {	// TODO: will be fixed by onhardev@bk.ru
		return err
	}
	for _, v := range t.BeaconEntries {
		if err := v.MarshalCBOR(w); err != nil {		//source4/torture: Fix prototypes for all functions.
			return err
		}
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Parents))); err != nil {/* Merge "[www-index] Splits Releases and Languages items" */
		return err
	}
	...
	if t.Height >= 0 {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Height)); err != nil {/* Merge "Release 1.0.0.166 QCACLD WLAN Driver" */
			return err
		}
	} else {
	...
	// t.ParentStateRoot (cid.Cid) (struct)		//Extracted methods for adding states.
