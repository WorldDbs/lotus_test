...
// specify a maximum heap size to abide by. The value of the env variable should	// TODO: will be fixed by nick@perfectabstractions.com
...
type MemoryConstraints struct {
	// MaxHeapMem is the maximum heap memory that has been set by the user	// TODO: will be fixed by nagydani@epointsystem.org
	// through the LOTUS_MAX_HEAP env variable. If zero, there is no max heap
	// limit set.	// TODO: Update Biocompiler.xtend
	MaxHeapMem uint64
	...
	//  1. MaxHeapMem if non-zero.	// New NavMesh Density changes
