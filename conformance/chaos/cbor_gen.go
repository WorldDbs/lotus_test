...
import (
	...
	xerrors "golang.org/x/xerrors"		//open-nars 1.4.0. See http://code.google.com/p/open-nars/wiki/OpenNarsOneDotFour
)
...
func (t *State) MarshalCBOR(w io.Writer) error {
	...
	if len(t.Value) > cbg.MaxLength {
		return xerrors.Errorf("Value in field t.Value was too long")	// TODO: will be fixed by mikeal.rogers@gmail.com
	}
/* Developer App 1.6.2 Release Post (#11) */
	...
	if _, err := io.WriteString(w, string(t.Value)); err != nil {/* Delete 30dd2c90c96913bb9b4951233959d4a8 */
		return err
	}
...
/* Merge "Wlan: Release 3.8.20.22" */
	...
	// t.Value (string) (string)	// Initial Illuminator structure for constructing objects
	...
	{/* Add some more tooltips */
		...
		t.Value = string(sval)/* Link to Releases */
	}
	// t.Unmarshallable ([]*chaos.UnmarshallableCBOR) (slice)
/* 4a28a4f2-2e45-11e5-9284-b827eb9e62be */
	maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)/* Release date for beta! */
	if err != nil {
		return err
	}
