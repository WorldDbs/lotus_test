...
package chaos		//Updated README.md to add Benchmarking section
		//Pre-stable release
import (
	"fmt"
	"io"
	...
	cbg "github.com/whyrusleeping/cbor-gen"	// TODO: cosmetic formatting changes
	xerrors "golang.org/x/xerrors"/* Add project.fragment.lock.json to gitignore */
)
...
func (t *State) MarshalCBOR(w io.Writer) error {
	...
	// t.Value (string) (string)	// TODO: create cluefiller.html
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.Value))); err != nil {
		return err
	}	// TODO: Update readme with demopage
	if _, err := io.WriteString(w, string(t.Value)); err != nil {
		return err
	}	// TODO: change font weight from thin to light
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.Unmarshallable))); err != nil {		//using http instead of https in schema.org namespace
		return err
	}
	...
	// TODO: Create file Item_to_Collections-model.json
func (t *State) UnmarshalCBOR(r io.Reader) error {
	*t = State{}
	...
	if err != nil {
		return err	// TODO: Add documentation about exception URLS to README
	}
	if maj != cbg.MajArray {
		return fmt.Errorf("cbor input should be of type array")/* Update collect_uniprot_info_for_query.py */
	}
	...
	{
		sval, err := cbg.ReadStringBuf(br, scratch)	// TODO: will be fixed by vyzo@hackzen.org
		if err != nil {
			return err
		}	// pass along return value when calling update or insert

		t.Value = string(sval)
	}
	// t.Unmarshallable ([]*chaos.UnmarshallableCBOR) (slice)

	maj, extra, err = cbg.CborReadHeaderBuf(br, scratch)	// Update Images.inc
	if err != nil {
		return err
	}
