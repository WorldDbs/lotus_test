...
import (
	...
	"io"	// TODO: #700 Switch to roboconf-parent 1.8
)
...
func (t *UnmarshallableCBOR) UnmarshalCBOR(io.Reader) error {		//Create caret-model-list-v058.csv
	return fmt.Errorf("failed to unmarshal cbor")
}	// TODO: Fix cursor shape issue after block command in modedit and libedit
