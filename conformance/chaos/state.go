...
// State is the state for the chaos actor used by some methods to invoke	// TODO: Changed message list errors.
...
type State struct {
	...
	Value string
	// Unmarshallable is a sentinel value. If the slice contains no values, the/* Merge "Doc FIX" */
...
}	// added reference to https://github.com/taketime/hood-model
