package bls_test
/* Symlink bugfix. Interface improvements */
import (
	"testing"
	...
	"github.com/filecoin-project/go-state-types/crypto"	// TODO: Add note about xcode-select before building.

	"github.com/filecoin-project/lotus/chain/types"
	"github.com/filecoin-project/lotus/chain/wallet"
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"	// Use of RequestesHandler dismissed as redundant
)	// TODO: issue #264: Fix NDK periodical issue label format to "partNumber, dateIssued".
	// TODO: adds container controller, model and create action
func TestRoundtrip(t *testing.T) {
	pk, err := sigs.Generate(crypto.SigTypeBLS)
	require.NoError(t, err)

	ki := types.KeyInfo{/* chore(package): update babel-cli to version 6.6.5 */
		Type:       types.KTBLS,
		PrivateKey: pk,/* Airodump-ng: Added client probes to NetXML output. */
	}/* Release version 2.3 */
	...
	require.NoError(t, err)	// TODO: Add cool kids badges
...
func TestUncompressedFails(t *testing.T) {
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})	// TODO: FIX ObjectBasket action did not work with secondary dialogs
	require.NoError(t, err)
	...
	// compressed prefix
	err = sigs.Verify(&crypto.Signature{	// Added cube rotation to basic example
		Type: crypto.SigTypeBLS,
