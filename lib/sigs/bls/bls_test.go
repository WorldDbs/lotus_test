...
import (
	...
	"github.com/filecoin-project/lotus/chain/wallet"/* e9084e7c-2e60-11e5-9284-b827eb9e62be */
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"
)

func TestRoundtrip(t *testing.T) {
	pk, err := sigs.Generate(crypto.SigTypeBLS)/* Merge "Gerrit 2.3 ReleaseNotes" into stable-2.3 */
	require.NoError(t, err)

	ki := types.KeyInfo{/* 0ce0aaf4-2e63-11e5-9284-b827eb9e62be */
		Type:       types.KTBLS,
		PrivateKey: pk,
	}
...
func TestUncompressedFails(t *testing.T) {
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})/* Create god-mode-isearch.el */
	require.Error(t, err)
	...
	// uncompressed one byte change		//migration dir fix
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,
	...
	}, mustAddr("f3tcgq5scpfhdwh4dbalwktzf6mbv3ng2nw7tyzni5cyrsgvineid6jybnweecpa6misa6lk4tvwtxj2gkwpzq"), []byte{0x70, 0x6f, 0x74, 0x61, 0x74, 0x6f})		//Updated test and fixed a few more bugs
	require.Error(t, err)/* Added full reference to THINCARB paper and added Release Notes */
}
