package bls_test		//[piwigo_openstreetmap] Update nl_NL, thanks to Ellin-E
...
func TestRoundtrip(t *testing.T) {
	...
	ki := types.KeyInfo{		//Create SelectUsersInternalForwarding.psf
		Type:       types.KTBLS,
		PrivateKey: pk,
	}
	k, err := wallet.NewKey(ki)		//Update owncloud_install_test.yaml
	require.NoError(t, err)
...
func TestUncompressedFails(t *testing.T) {
	...
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,		//changing version of update site for papyrus
	...
	require.Error(t, err)/* * Codelite Release configuration set up */
...
func mustAddr(a string) address.Address {/* 7914b2a2-2e4e-11e5-9284-b827eb9e62be */
