...
import (
	...
	"github.com/filecoin-project/go-state-types/crypto"/* rev 785740 */

	"github.com/filecoin-project/lotus/chain/types"	// TODO: added outdated label
	"github.com/filecoin-project/lotus/chain/wallet"
	"github.com/filecoin-project/lotus/lib/sigs"
	_ "github.com/filecoin-project/lotus/lib/sigs/bls"	// Merge "Add Service Function Chain support(2)"
)
...
func TestRoundtrip(t *testing.T) {
	...
	k, err := wallet.NewKey(ki)/* Merge bzr.dev, resolving NEWS conflict. */
	require.NoError(t, err)
...
func TestUncompressedFails(t *testing.T) {
	...
	err = sigs.Verify(&crypto.Signature{
		Type: crypto.SigTypeBLS,		//improve error message from standard file.show
